...
[Plug-and-play substitute for Pytorch DataLoader, better in every way, leveraging truly-shared memory from scratch accelerated across domains, and with the best possible interface for use in reinforcement learning as an experienced replay, prioritized experience replay, or other parallel, distributed, algorithmically novel versions, including priority-sampling without replacement by multiple parallel-CPU workers and memory-mapping, fully unified with dynamically growing and agent-re-writable datasets/replay memories.](https://github.com/slerman12/Builder/blob/main/UnifiedML/src/ML/World/Replay.py)
