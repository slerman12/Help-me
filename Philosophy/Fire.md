...
Careful with that [heavy water though](https://en.wikipedia.org/wiki/CANDU_reactor)! The extra neutron of deuterium (heavy water) is a bit unfriendly with uranium. Like the energy from the electrons on hydrocarbons, it pierces the uranium and starts a hailstorm of neutrons flying out and doing the same.
