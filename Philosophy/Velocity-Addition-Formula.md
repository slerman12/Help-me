...
However, the issue isn't just the velocity-addition formula. Einstein's first postulate also renders the Lorentz transformation useless in all slower-than-light-speed scenarios. I'm not sure what the bigger issue is, that physicists either miss or ignore this (if they maintain conviction in so doing), or that there's a blaring misattribution of theory to experimental result. But maybe I am crazy for thinking $x = ct$ means $x = ct$.
