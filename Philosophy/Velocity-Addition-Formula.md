...
However, the issue isn't just Einstein's first postulate with the velocity-addition formula. Einstein's first postulate also renders the Lorentz transformation useless in all slower-than-light-speed scenarios. I'm not sure what the bigger issue is (depending on the outcome of reading this), that physicists either miss or ignore Einstein's first postulate, or that there's a blaring misattribution of theory to experimental result. But maybe I am crazy for thinking $x = ct$ means $x = ct$.
