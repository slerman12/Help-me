...
To be clear, Einstein assumes $x$ and $x'$ to be the spatial coordinate points (for reference frames $K$ and $K'$ respectively) of a single light beam, *in vacuo*, or otherwise some object traveling at speed $c$, in the first postulate. There is no circumventing that, despite the ubiquitous misunderstanding.
