...
>
> As for the existence of the un-specified deducer, usually this doesn't need proving in a derivation, but just for my satisfaction, here is proof to formalize that without further axiom: "You observe, therefore an observer (you) exists." $\square$
> - Note: derivation doesn't depend on this point. The proof stands entirely without it.
>
