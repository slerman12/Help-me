...
> One more critique is that, why go this roundabout way and not just represent the universe with some hypothetical decimal, e.g. $\pi$, that contains within it an encoding of everything? Well, the number line is a bigger assumption than the one I'm making, and requires specific definitions assumed as true. I have made no further assumptions than deduction itself.
