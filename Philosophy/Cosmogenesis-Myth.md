...
As for the existence of an un-specified deducer, usually this doesn't need proving in a derivation, but just in case, here is proof to formalize that without further axiom: "You observe, therefore an observer (you) exists." $\square$
