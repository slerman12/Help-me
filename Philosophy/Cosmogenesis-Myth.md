...
As for the un-specified deducer, in this case it's us and we definitely exist. Here is proof to formalize that without further axiom: "You observe, therefore an observer (you) exists." $\square$.
