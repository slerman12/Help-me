...
That being said, there is now the critique of how I obtain the subscripts of the nothings if there is no number line. The subscripts don't need to be numbers. They can be any variable. For example, a hidden definition in the definition of definition is the existence of that definition. So an arbitrary definiton can be constructed as a placeholder for any such such subscript variables. See [Afterward ](#Afterward) for how this hack can be exploited further.
