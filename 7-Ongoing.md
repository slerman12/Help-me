...
The PhD student handbook has one clause of accountability for the grad school, and it's to specify, in writing, what the PhD student would need to do (without pay or support) for reinstatement, when support is withdrawn.
...
Also, I replied to the email that mentioned reinstatement (when it was sent, on the last day of being a grad student) asking for evidence and my reply was ignored. It was the last message sent between us, prior to [these ones](#email-02072024) that I reinstated also currently being ignored in which I explicitly mentioned the "what is necessary" clause.
