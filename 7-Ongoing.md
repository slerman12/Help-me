...
- They can't claim “just doing their jobs” as an excuse for these events, because they aren’t, even by their own policy where all of their claims are treated as steel (by supposing every reason they had for terminating me was true, any one of them suffices, and I didn’t do anything they suggested or requested of me, that is, "steel-manning," as opposed to ["straw-manning"](https://en.wikipedia.org/wiki/Straw_man)).
- I wrote in the email, "Also, Michael, why does a six-month review make-up have so much weight when I had to report to two labs every action I took every week for the last 3 years?" Seems somewhat pedantic. But it's policy. So the **wisdom** of the University of Rochester says that policy is policy. Then so is this one being **broken** by the University of Rochester, right now. 
