...
- They can't claim “just doing their jobs” as an excuse for these events, because they aren’t, even by their own policy under these steel-man suppositions.
- I wrote in the email, "Also, Michael, why does a six-month review make-up have so much weight when I had to report to two labs every action I took every week for the last 3 years?" Seems somewhat pedantic, oh but it's policy. And policy is policy, and that's the University of Rochester's **wisdom**. Then so is this one being **broken** by the University of Rochester right now. And with that I would yeild the floor.
