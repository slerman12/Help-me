...
- I replied to that reinstatement-mentioning email when it was sent on **10/31/2024**, that is, on my last day of being an employed grad student, asking for evidence for one of the termination reasons and my reply was ignored. It was the last message sent between us, prior to [these ones above](#email-02072024) that I resumed also currently being ignored. In the [above email](#email-02072024) (the latest of the ignored), I brought up that the reinstatement-condition wasn't indicated to me.
...
- Support, as distinct from pay, was withdrawn long before Michael or any faculty mentioned reinstatement.
  - As evidenced by the many tortures, including permanent ongoing ones and [flares of physically debilitating ones](https://github.com/slerman12/BrokenWisdoms/blob/Ancillary/Eczema.md), inflicted by his institution. 
