...
Also, I replied to that email (when it was sent, that is, on my last day of being a stipend-receiving grad student) asking for evidence for the given termination reasons and my reply was ignored. It was the last message sent between us, [these ones](#email-02072024) above that I resumed also currently being ignored. In the [above email](#email-02072024) (the latest of the ignored emails mentioned), I brought up that the reinstatement-condition wasn't indicated to me.
