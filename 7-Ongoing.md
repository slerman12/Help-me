...
He also mentioned applying for reinstatement, but the university provides no "reinstatement applications" for PhD students, nor does that answer on what conditions, whether any advisor or source of income would be provided, and if not, how to go about obtaining those without any further connections or resources to do so. 
