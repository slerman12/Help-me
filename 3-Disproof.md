...
Note also: the University of Rochester's CS department doesn't have PhD "reinstatement applications." Any appearance of the below email as indicating a reinstatement-condition is gaslighting. There's a difference between indicating and gaslighting, just as there's a difference between in writing and in person, and, formally, one cannot be relegated as another.
