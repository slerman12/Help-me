...
They cherrypick the values, visions, and policies (e.g., "bad standing" in department), but instead of doing so with the purpose of creating love (e.g., helping find a new advisor), they do so without thought or empathy to what's at stake for them (e.g., the high stake of their billion-dollar institution paying less than New York State's living wage) vs. what's at stake for someone else (e.g., losing at least 6 years of his life undeservedly despite good, hard work after enormous injustice without them addressing his disclosing them that injustice), what will have to be done by them (e.g., not making a termination decision), and what will have to be done by the person ruled on (e.g., the 14 items listed above). They are bad rulers (e.g., the aforementioned ruling practices). And promote the policy of fascism when any ambiguity lets them, e.g.: They promote greed (e.g., saving money due to "not enough papers") and self-serving decisions (e.g., sabbaticals and promotions) and impartial rulings (e.g., the 6-month review of a brand new committee) whenever reward or laziness is at stake (e.g., no calling on witnesses or cross-reporting of work). Greed is the root of economic domination, self-serving decisions are the root of nationalism and ethno-centrism, and impartial rulings are the root of blind loyalty to systems. Those roots in action as described sufficiently meet the definition of fascism in my opinion, though I am not a PhD in political philosophy.
