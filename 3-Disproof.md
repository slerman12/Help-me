...
In this first of the email chains that he ignored my reply to, Michael reached out to meet in person, but that wouldn't suffice for reinstatement nor secure my future as an employee with a salary, advisor, and a basic standard of living. The reason for wanting to meet was "mutual understanding." That is far from a necessary condition for reinstatement, and to establish it as such requires explicitness as well as a violation of ethics in demanding an unpaid meeting with a stranger actively inflicting trauma who has no background or expertise in my field as the only imaginable grounds for reinstatement.
